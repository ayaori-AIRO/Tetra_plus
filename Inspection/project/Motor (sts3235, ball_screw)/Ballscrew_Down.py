...
def stop(client):
    client.write_registers(0x00F6, [(DIR_CCW << 8) | ACC, 0], device_id=DEVICE_ID)
...
try:
    ...
    print(f"볼스크류 DOWN 이동 시작 | 방향: CCW | 이동량: {TRAVEL}")
    move_relative(client, DIR_CCW, TRAVEL, ACC, SPEED)
